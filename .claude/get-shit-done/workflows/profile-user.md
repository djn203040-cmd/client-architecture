...
Key references:
- @/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/USER-PROFILE.md" "/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/CLAUDE.md
```
