...
```
Task(
  prompt="Read /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/templates/SECURITY.md`
