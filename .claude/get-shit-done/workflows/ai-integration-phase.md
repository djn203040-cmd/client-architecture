...
<required_reading>
@/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/references/ai-frameworks.md
@/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/agents/gsd-eval-planner.md for instructions.
