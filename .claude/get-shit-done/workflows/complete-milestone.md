...
**If doesn't exist:** Create from template at `/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/templates/retrospective.md`.
