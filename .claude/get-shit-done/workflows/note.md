...
- **Global scope**: `/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/notes/`)
...
2. Glob `/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/notes/` — works in any directory
