...
The keys live in `.claude/settings.json` (project) or `/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/settings.json` (global) — **not** in `.planning/config.json`:
