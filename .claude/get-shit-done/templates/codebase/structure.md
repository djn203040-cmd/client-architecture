...
- Usage: Reference from command with `@/Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/augustavesterlyngvilsoe/Desktop/Claude code/Program for coaches/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
