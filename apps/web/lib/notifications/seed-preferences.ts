...
const DEFAULT_MATRIX: Array<{
  ...
  { event_type: "call_outcome_pending", channel: "slack",     enabled: true },
  { event_type: "call_outcome_pending", channel: "whatsapp",  enabled: true },
  { event_type: "call_outcome_pending", channel: "sms",       enabled: false },
];
