...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "Here's a draft the AI already wrote for Alex. Read it, edit inline if you'd like, then Approve to send — or Hold to park it. Tip: press A to approve, H to hold. Go ahead and approve this one.",
    placement: "top",
    needsDemoLead: true,
  },
  {
  ...
  },
  {
    ...
    body: "Every scheduled message surfaces here 24 hours before it sends. Fly through them with A to approve, S to skip, H to hold — or edit any draft first. Empty right now; it fills as your sequences run.",
    placement: "top",
  },
  {
    id: "goto-calls",
